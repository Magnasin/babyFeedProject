...
to install mongodb:
	...
	4. to stop the process on the terminal:     ctrl + c

	5. to active the mongodb:	      			sudo systemctl enable mongod

	6. to start mongodb:		  				sudo systemctl start mongod

	7. to check mongodb status:	      			sudo systemctl status mongod
					    ...
					    Docs: https://docs.mongodb.org/manual
										...
										NOTE: MONGODB IS ACTIVE 
					    
	8. to stop the process on the terminal:     ctrl + c
...
to install Apache Maven:
	...
	2. unzip the file to /opt: 				sudo tar xf /home/val0dia/Downloads/apache-maven-3.8.1-bin.tar.gz -C /opt
	...
	4. copy the following inside the file maven.sh:
	...
	5. copy maven.sh file to the /etc/profile.d directory:	sudo cp /home/val0dia/Desktop/maven.sh /etc/profile.d/maven.sh

										NOTE: YOU NEED TO UPDATE THE PATH FOR YOUR maven.sh FILE.


	6. make the script executable with:			sudo chmod 777 /etc/profile.d/maven.sh

	7. load the environment variables:			source /etc/profile.d/maven.sh

	8. check version: 							mvn -version 
...
1. to open the Explorer ctrl + shift + E: 
      ...
      1. right click on ffq-authentication-service directory and click on Open in integrated Terminal and run the terminal: 
      ...
      2. right click on ffq-food-item-service directory and click on Open in integrated Terminal and run the terminal: 
      ...
      3. right click on ffq-questionnaire-web directory and click on Open in integrated Terminal and run the terminal: 
      ...
      4. right click on ffq-user-service directory and click on Open in integrated Terminal and run the terminal: 
      ...
      5. right click on ffquestionnaire-service directory and click on Open in integrated Terminal and run the terminal: 
